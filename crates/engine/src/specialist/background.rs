...
pub const TITLE_GENERATION: Specialist = Specialist {
    name: "title_generation",
    gpu_role: GpuRole::Background,
    toolbelts: &[],
    instructions: "\
...
pub const SUMMARIZATION: Specialist = Specialist {
    name: "summarization",
    gpu_role: GpuRole::Background,
    toolbelts: &[],
    instructions: "\
...
pub const MEMORY_EXTRACTION: Specialist = Specialist {
